        ...
        if(scanCallback21 == null){
            scanCallback21 = new ScanCallback() {
                ...
                public void onScanResult(int callbackType,  ScanResult result) {
                    ...
                    android.util.Log.i(TAG, "onScanResult: before sleep");
//                    try {
//                        android.os.SystemClock.sleep(7000);
//
//                    } catch (Exception e) {
//                        android.util.Log.e(TAG, "onScanResult: "+e.getMessage() );
//                    }
                    android.util.Log.i(TAG, "Android:onScanResult: "+result.toString());
                ...
                public void onBatchScanResults(List<ScanResult> results) {
                    ...
                    android.util.Log.i(TAG, "onBatchScanResults: "+results.size());
